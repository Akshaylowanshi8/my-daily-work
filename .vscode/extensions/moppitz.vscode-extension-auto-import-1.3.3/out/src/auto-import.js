...
class AutoImport {
    ...
    attachCommands() {
        let codeActionFixer = vscode.languages.registerCodeActionsProvider(['javascript', 'typescript'], new import_action_1.ImportAction());
        ...
        let completetion = vscode.languages.registerCompletionItemProvider(['javascript', 'typescript'], new import_completion_1.ImportCompletion(this.context, vscode.workspace.getConfiguration('autoimport').get('autoComplete')), '');
